    ...
    <>
      {bannerOpen && (
        <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
          <div className="dark:bg-gray-800 dark:border-gray-700/10 border border-transparent bg-gray-100 text-gray-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-gray-500 inline-flex">
              <a
                className="font-medium hover:underline dark:text-gray-50 text-gray-700"
                href={liteLink}
                target="_blank"
                rel="noreferrer"
              >
