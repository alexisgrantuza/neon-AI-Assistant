...
function Header({ sidebarOpen, setSidebarOpen, variant = "default" }) {
  ...
  return (
    <header
      className={`sticky top-0 before:absolute before:inset-0 before:backdrop-blur-md max-lg:before:bg-white/90 dark:max-lg:before:bg-black before:-z-10 z-60 ${
        variant === "v2" || variant === "v3"
          ? "before:bg-white after:absolute after:h-px after:inset-x-0 after:top-full after:bg-white dark:after:bg-black after:-z-10"
          : "max-lg:shadow-sm lg:before:bg-white dark:lg:before:bg-black"
      } ${variant === "v2" ? "dark:before:bg-black" : ""} ${
        variant === "v3" ? "dark:before:bg-black" : ""
      }`}
    >
